...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [1] = LAYOUT_universal(
    ...
    KC_LSFT  , KC_1     , KC_2     , KC_3    , KC_4     , KC_5     ,                                         KC_6     , KC_7     , KC_8     , KC_9     , KC_0     , KC_RSFT  ,
                  KC_LALT  , _______ , KC_LGUI  ,         _______  , SCRL_MO  ,                   _______  , MO(3)    , _______       , _______  , _______
  ),
  ...
  [3] = LAYOUT_universal(
    _______  , _______  , _______  , _______  , _______ , _______  ,                                        _______  , _______  , CPI_D100 , CPI_D1K , AML_D50 , QK_BOOT  ,
