...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = LAYOUT_universal(
    ...
    KC_LSFT  , KC_Z     , KC_X     , KC_C    , KC_V     , KC_B     ,                                         KC_N     , KC_M     , KC_COMM  , KC_DOT   , KC_SLSH  , KC_RSFT  ,
                  KC_LALT  , KC_LNG2 , KC_LGUI  ,         MO(1)    , KC_SPC   ,                    KC_ENT  , MO(2)    , _______       , _______  , KC_LNG1
  ),

  [1] = LAYOUT_universal(
    KC_TAB   , _______  , _______  , _______ , _______  , _______  ,                                         _______  , _______  , _______  , _______  , _______  , KC_BSPC  ,
    KC_LCTL  , S(KC_1)  , S(KC_2)  , S(KC_3) , S(KC_4)  , S(KC_5)  ,                                         S(KC_6)  , S(KC_7)  , S(KC_8)  , S(KC_9)  , S(KC_0)  , KC_F12   ,
    KC_LSFT  , KC_1     , KC_2     , KC_3    , KC_4     , KC_5     ,                                         KC_6     , KC_7     , KC_8     , KC_9     , KC_0     , KC_RSFT  ,
                  KC_LALT  , _______ , KC_LGUI  ,         _______  , SCRL_TO  ,                   _______  , MO(3)    , _______       , _______  , _______
  ),
  ...
  [2] = LAYOUT_universal(
    ...
    KC_LSFT  , KC_F1    , KC_F2    , KC_F3   , KC_F4    , KC_F5    ,                                         KC_BTN4  , KC_BTN1  , KC_BTN2  , KC_BTN5  , _______  , KC_GRV   ,
                  KC_LALT  , _______ , KC_LGUI  ,         M0(3)    , _______  ,                   _______  , _______    , _______       , _______  , _______
  ),

  [3] = LAYOUT_universal(
    _______  , _______  , _______  , _______  , _______  , _______  ,                                        _______  , _______  , _______  , _______ , _______ , _______  ,
    _______  , _______  , _______  , _______  , _______  , SCRL_DVI ,                                        CPI_D1K  , CPI_D100 , CPI_I100 , CPI_I1K , _______  , _______  ,
